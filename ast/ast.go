...
type SliceExpression struct {
	Token token.Token // The [ token
	Left  Expression
	Start Expression // Optional (can be nil)
	End   Expression // Optional (can be nil)
}
...
// for i < 10 { ... }
// for var i = 0; i < 10; i++ { ... }
// This needs a specialized AST node.
// Simplified: ForExpression (loops are statements usually, but we can make them expressions returning null)
